...
var apiHost = flag.String("host", "https://icfpc.sx9.jp", "")
...
func RunAcquire(ctx context.Context) (*RunAcquireResponse, error) {
	req, err := http.NewRequest("POST", *apiHost + "/api/run/acquire", nil)
	if err != nil {
